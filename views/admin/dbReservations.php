                ...
                <table>
                    <?php for ($i=1; $i < 10; $i++) { ?>
                        <tr class="colored" id="<?= $i ?>">
                            ...
                            <td class="comment">Végétarien Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga illum delectus dolores hic accusantium quibusdam quod. Architecto animi omnis perferendis iure modi placeat!</td>
                            <td class="edit">
