        ...
        <div class="sidebar">
            ...
            <ul>
                <li>
                    ...
                    <a href="../../controllers/admin/dbMenuController.php">Menu</a></li>
                <li>
                    ...
                    <a href="../../controllers/admin/dbReviewsController.php">Commentaires</a></li>
                <li>
                    ...
                    <a href="../../controllers/admin/dbRegisterController.php">Membres</a></li>
                <li>
                    ...
                    <a href="../../controllers/admin/dbReservationsController.php">Réservations</a></li>
            </ul>
        </div>