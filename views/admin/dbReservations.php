                ...
                <table>
                    <?php for ($i=1; $i < 10; $i++) { ?>
                        <tr class="colored" id="<?= $i ?>">
                            ...
                            <td class="comment" colspan="2">Végétarien Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga illum delectus dolores hic accusantium quibusdam quod</td>
                            <td class="edit">
